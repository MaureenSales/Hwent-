...
public class CardDataBase : MonoBehaviour
{
   ...
   public void Awake()
   {
     ...
     "El niño que vivió. El elegido para derrotar al señor tenebroso", Resources.Load<Sprite>("HarryPotter")));
      ...
      //Gryffindor
      Gryffindor.AddCard(new Unit("Arthur Weasley", Global.Factions.Gryffindor, "", "Patriarca de la Familia Weasley, conocido por su amor por los objetos muggles, su curiosidad científica y su papel en el Ministerio de Magia",
      5, new List<Global.AttackModes>() { Global.AttackModes.Melee }, Resources.Load<Sprite>("ArthurWeasley")));
      Gryffindor.AddCard(new Unit("Colin Creevey", Global.Factions.Gryffindor, "", "Durante su primer año en Hogwarts, hizo muchas fotos de Harry y otros estudiantes. A lo largo de su tiempo en la escuela, su admiración por Harry nunca disminuyó.",
      3, new List<Global.AttackModes>() { Global.AttackModes.Ranged }, Resources.Load<Sprite>("ColinCreevey")));
      Gryffindor.AddCard(new Unit("Fred y George Weasley", Global.Factions.Gryffindor, "", "Magos gemelos, ambos son expertos en bromas y fundaron la tienda de artículos de broma Sortilegios Weasley.",
      ...
      Gryffindor.AddCard(new Unit("Lavender Brown", Global.Factions.Gryffindor, "", "Lavender era una chica algo tonta y sentimental, aunque también era valiente, tenía un gran interés en la Adivinación.",
      3, new List<Global.AttackModes>() { Global.AttackModes.Siege }, Resources.Load<Sprite>("LavenderBrown")));
      Gryffindor.AddCard(new Unit("Minerva McGonagall", Global.Factions.Gryffindor, "", "trbajó en el Ministerio de Magia y luego regresó a Hogwarts, donde se convirtió en Jefa de la Casa Gryffindor, profesora de Transformaciones y subdirectora de Hogwarts. Lucha por lo justo y honesto.",
      11, new List<Global.AttackModes>() { Global.AttackModes.Melee }, Resources.Load<Sprite>("MinervaMcGonagall")));
      Gryffindor.AddCard(new Unit("Neville Longbottom", Global.Factions.Gryffindor, "", "Pasó de ser un chico tímido e introvertido a ser un valiente defensor de Hogwarts, responsable de la decapitación de Nagini.",
      ...
      //Slytherin
      Slytherin.AddCard(new Unit("Andromeda Tonks", Global.Factions.Slytherin, "", "Bruja Black, valiente que desafió las normas y defendió el amor por encima de la pureza de sangre al casarse con un muggel.",
      ...
      Slytherin.AddCard(new Unit("Pansy Parkinson", Global.Factions.Slytherin, "", "Líder del grupo de las chicas de Slytherin. Ella y Draco eran mezquinos y tenían una considerable influencia y poder dentro de su grupo de amigos, y se sirvieron de ese poder para intimidar a otros estudiantes.",
      4, new List<Global.AttackModes>() { Global.AttackModes.Siege }, Resources.Load<Sprite>("PansyParkinson")));
      Slytherin.AddCard(new Unit("Regulus Black", Global.Factions.Slytherin, "", "Hermano menor de Sirus Black, creía en la sangre pura. Desempeñó un papel crucial en la búsqueda y recuperación del Guardapelo de Slytherin, uno de los Horrocruxes de Voldemort.",
      7, new List<Global.AttackModes>() { Global.AttackModes.Melee }, Resources.Load<Sprite>("RegulusBlack")));
      Slytherin.AddCard(new HeroUnit("Severus Snape", Global.Factions.Slytherin, "", "Snape era un hechicero formidable, mostrando una habilidad consumada en muchas ramas diferentes de magia, Maestro de Posiones y Defensa Contra las Artes Oscuras.",
